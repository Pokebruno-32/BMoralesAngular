...
- Create Angular project with ng: `ng new bmoralesangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bmoralesangular.client.esproj`).
